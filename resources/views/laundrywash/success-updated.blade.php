<div class="col-sm-12">
    <br/>
    <h3 class="text-muted text-success text-center">Laundry Has Been Updated Successfully!</h3>
    ...
    <div class="row mtop-20">
        <div class="col-md-12">
            <a href="{{ route('laundry.index') }}" class="btn btn-info btn-lg btn-block">New Laundry <i class="fa fa-plus"></i></a>
        </div>
    </div>
    <br/>
</div>
