...
<div id="printbox">
    ...
    <table class="inv_info">
        ...
        <tr>
            <td>Department</td>
            <td>{{ getActiveStore(false, $invoice->warehousestore_id)->name }}</td>
        </tr>
        <tr>
            <td>Status</td>
    ...
    <table id="products">
        ...
        @foreach($invoice->laundry_items as $item)
            <tr>
                ...
                <td align="left" class="text-left">{{ $item->cloth_service_mapper->cloth->cloth_name }} - {{ $item->cloth_service_mapper->laundry_service->laundry_service_name }}</td>
