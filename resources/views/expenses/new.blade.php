                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ old('expense_date', (isset($expenses->expense_date) ? date('Y-m-d', strtotime($expenses->expense_date)) : date('Y-m-d'))) }}" required  value="{{ date('Y-m-d') }}" data-min-view="2" data-date-format="yyyy-mm-dd" class="form-control datepicker js-datepicker" id="invoice_date" name="expense_date" placeholder="Date"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="department">
                                                @foreach($depts as $dept)
                                                    <option {{ old('department',$expenses->department) ==  $dept ? "selected" : ""  }}  value="{{ $dept }}">{{ $dept }}</option>
                                                @endforeach
                                            </select>
