                    ...
                    <header class="panel-heading">
                        ...
                        @if(userCanView('services.create'))
                            <span class="tools pull-right">
                                            <a  href="{{ route('cloths.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> New Cloth Type</a>
                            </span>
                        @endif
                    </header>
                        ...
                        <table class="table table-bordered table-responsive table convert-data-table table-striped">
                            ...
                            @foreach($cloths as $cloth)
                                <tr>
                                    ...
                                    <td>{{ $cloth->cloth_description }}</td>
                                    <td>
                                        @if(userCanView('cloths.edit'))
                                            <a  href="{{ route('cloths.edit', $cloth->id) }}" class="btn btn-success btn-sm">Edit</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
