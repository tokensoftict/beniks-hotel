                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form  action="{{ route('stocklog.add_log') }}" enctype="multipart/form-data" method="post">
                            ...
                            @if(auth()->user()->warehousestore_id == NULL)
                            <div class="form-group">
                            ...
                            @else
                                ...
                                <span class="form-control">{{ getActiveStore(false, auth()->user()->warehousestore_id)->name }}</span>
                                <input type="hidden" value="{{ auth()->user()->warehousestore_id }}" name="store"/>
                            @endif
                            <br/>
                            <div class="form-group">
                                <label>Date</label>
