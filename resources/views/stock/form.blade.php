                    ...
                    <div class="col-md-4">
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body" >
                                ...
                                <div class="form-group">
                                    <label>Stock Department  <span style="color:red;">*</span></label>
                                    <select class="form-controls select2-department" required name="departments[]" multiple>
                                        <option value="">Select Department</option>
                                        @foreach($departments as $department)
                                            <option {{ in_array($department->id, $stock_departments) ? 'selected' : "" }} value="{{ $department->id }}">{{ $department->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="panel-body" >
                                ...
                                @elseif(config('app.store') == "hotel")
                                 <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>VVIP Selling Price</label>
                                        <input type="number" step="0.00001" value="{{ old('vip_selling_price',$stock->vvip_selling_price) }}"   class="form-control" name="vvip_selling_price" placeholder="VVIP Selling Price"/>
                                    </div>
                                    <div class="form-group">
                                        <label>Executive Selling Price</label>
                                        <input type="number" step="0.00001" value="{{ old('executive_selling_price',$stock->executive_selling_price) }}"   class="form-control" name="executive_selling_price" placeholder="Executive Selling Price"/>
                                    </div>
                                @endif
                            </div>
                        </section>
