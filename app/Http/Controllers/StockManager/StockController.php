...
use App\Models\StockDepartmentMapper;
...
class StockController extends Controller
{
    ...
    public function index(){
        ...
        if(config('app.inventory') == "inventory")
        {
    ...
    public function create(){
        ...
        $data['departments'] = Warehousestore::select('id','name')->get();
        $data['stock_departments'] =  [];
    ...
    public function edit($id){
        ...
        $data['suppliers'] = Supplier::where('status',1)->get();
        $data['departments'] = Warehousestore::select('id','name')->get();
        $data['stock_departments'] =  StockDepartmentMapper::where('stock_id', $id)->pluck('warehousestore_id')->toArray();
